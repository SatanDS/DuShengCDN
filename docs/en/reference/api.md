...
You will learn: The response structure, path conventions, authentication methods, and Swagger entry point for DuShengCDN management and Agent APIs.

Both the DuShengCDN management APIs and Agent APIs use JSON.
...
The Swagger files are located in `dushengcdn_server/docs`, generated by `swag init`.
